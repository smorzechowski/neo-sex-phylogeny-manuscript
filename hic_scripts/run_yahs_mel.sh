...
contigs="mel_nextpolish_assembly_tr.fasta" # need to be indexed, i.e., ${test}.contigs.fasta.gz.fai is present
hicaln="/n/holylfs04/LABS/edwards_lab/Lab/smorzechowski/meliphagid/analysis/2023-06-14/01-yahs/dedup/HiC_mel_178_rep1.bam"
