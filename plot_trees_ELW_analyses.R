...
par(mfrow=c(1,1))
plot(ladderize(trees[[1]],right=FALSE), tip.color=c("black","black","blue","blue","black","red",
                             "red","black","black","black",
                             "black","red"),main="Tree 1: no suppression.; monophyletic",cex=1.1);

plot(ladderize(trees[[2]],right=FALSE), tip.color=c("black","black","black","red","red","black",
...
plot(ladderize(T1Z,right=FALSE),tip.color=c("black","black","blue","blue",
                     "black","black","black","black",
                     "black"),main="Tree 1Z; ancestral Z monophyletic",cex=1.1,font=1);
...
plot(ladderize(T2Z,right=FALSE),tip.color=c("black","black","black","black",
                     "black","blue","blue","black",
                     "black"),main="Tree 2Z; ancestral Z paraphyletic",cex=1.1,font=1);

plot(ladderize(trees[[5]],right=FALSE), tip.color=c("black","black","blue","blue","red","red",
                             "red","black","black","black",
                             "black","black"),main="Tree 5: clade-wide RS; monophyletic",cex=1.1,font=1);

plot(ladderize(trees[[9]],right=FALSE), tip.color=c("black","black","red","red","red","black",
                             "black","black","blue","blue",
                             "black","black"),main="Tree 9: clade-wide RS; paraphyletic",cex=1.1,font=1);

plot(ladderize(trees[[1]],right=FALSE), tip.color=c("black","black","blue","blue","black","red",
                             "red","black","black","black",
                             "black","red"),main="Tree 1: no RS; monophyletic",cex=1.1,font=1);

trees[[1]]$tip.label

plot(ladderize(trees[[2]],right=FALSE), tip.color=c("black","black","black","red","red","black",
                             "black","blue","blue","black",
                             "black","red"),main="Tree 2: no RS; paraphyletic",cex=1.1,font=1);
